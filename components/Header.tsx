...
//       <div className="mx-auto grid w-full max-w-6xl grid-cols-[auto_1fr_auto] items-center gap-4 px-4 py-3 md:px-6">
...
//           </button>
//           <Link href="/" className="inline-flex items-center gap-2" aria-label="Mannequin Care home">
//             <Image src="/logo.jpg" alt="Mannequin Care" width={140} height={40} className="h-8 w-auto" priority />
//           </Link>
//         </div>
...
//           <div className="fixed inset-0 z-40 bg-white/80" aria-hidden />
//           <div
//             role="dialog"
//             aria-modal="true"
//             className="fixed inset-y-0 right-0 z-50 flex w-72 max-w-[85vw] flex-col bg-background px-4 py-6 shadow-xl"
//           >
//             <div className="flex items-center justify-between">
//               <Link href="/" className="inline-flex items-center gap-2" onClick={closeMobileMenu}>
//                 <Image src="/logo.jpg" alt="Mannequin Care" width={120} height={32} className="h-8 w-auto" />
//               </Link>
//               <button
//                 type="button"
