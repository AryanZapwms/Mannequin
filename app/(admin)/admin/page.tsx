...
import { ArrowUpRight, Package, ShoppingCart, Users2, Newspaper, Star, Inbox } from "lucide-react";
  ...
  return (
    <section className="space-y-8">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5">
        ...
        <Link href="/admin/messages" className="block transition-colors hover:bg-muted/40">
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">Contact enquiries awaiting a reply</p>
            </CardContent>
          </Card>
        </Link>
      </div>
